"""
security/encrypt.py — compress + base62 encode/decode for stream IDs and links.

Provides async encode_string / decode_string used across streaming, database,
and metadata caption flows.
"""
